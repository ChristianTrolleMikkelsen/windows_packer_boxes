...
C:\Windows\Temp\dotNetFx40_Full_x86_x64.exe /q /norestart /repair /log C:\Windows\Temp\dotnet40.log
...
C:\Windows\Temp\dotNetFx45_Full_x86_x64.exe /q /norestart /repair /log C:\Windows\Temp\dotnet45.log
...
C:\Windows\Temp\NDP451-KB2858728-x86-x64-AllOS-ENU.exe /q /norestart /repair /log C:\Windows\Temp\dotnet451.log
